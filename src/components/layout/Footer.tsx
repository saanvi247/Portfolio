    ...
    <footer className='bg-slate-950/40 backdrop-blur-md border-t border-slate-900 mt-20'>
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          <div>
            <h3 className='font-bold text-lg text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-400 mb-4'>Shubhaang Kataruka</h3>
            <p className='text-slate-400 text-sm leading-relaxed max-w-xs'>
              A professional space showcasing AI engineering, data systems, and full-stack development projects.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm text-slate-400'>
              ...
              <li><a href='https://www.linkedin.com/in/shubhaang-kataruka/' target='_blank' rel='noopener noreferrer' className='hover:text-sky-400 transition-smooth'>LinkedIn</a></li>
              <li><a href='https://github.com/shubhaang' target='_blank' rel='noopener noreferrer' className='hover:text-sky-400 transition-smooth'>GitHub</a></li>
            </ul>
          </div>
        </div>
        <div className='border-t border-slate-900 pt-8 text-center text-xs text-slate-600'>
          <p>&copy; {new Date().getFullYear()} Shubhaang Kataruka. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
